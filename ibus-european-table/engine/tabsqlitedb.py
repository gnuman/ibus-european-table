...
class tabsqlitedb:
    '''Phrase database for european-tables'''
    def __init__(self, name = 'table.db', user_db = None, filename = None ):
        ...
        if user_db != None:
            ...
            tables_path = path.join (home_path, ".ibus",  "european-tables")
        ...
        # try create all european-tables in user database
    ...
    def create_tables (self, database):
        '''Create european-tables that contain all phrase'''
    ...
    def select_words( self, tabkeys, onechar=False, bitmask=0 ):
        ...
        This method is called in european_table.py by passing UserInput held data
        Return result[:] 
        '''
